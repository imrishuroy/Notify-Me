...
class FirebaseBackendPage extends StatefulWidget {
  ...
  FirebaseBackendPage(this.firebaseAppToken) {
    prettyExampleMap = AwesomeMapUtils.printPrettyMap(firebaseDataSource
        .getFirebaseExampleContent(firebaseAppToken: firebaseAppToken));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title:
              Text('Firebase backend emulator', style: TextStyle(fontSize: 20)),
          leading: IconButton(
                    ...
                    children: <Widget>[
                      ...
                      SimpleButton(
                        ...
                        onPressed: () async {
                          ...
                          if (serverKeyValidation(fcmServerKey) == null ||
